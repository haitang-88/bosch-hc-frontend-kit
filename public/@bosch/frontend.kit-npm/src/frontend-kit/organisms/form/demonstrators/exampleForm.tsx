...
const ExampleFormDemonstrator: React.FunctionComponent = () => (
  <Form>
    ...
    <FormField fieldType="email" id="email" label="E-Mail address *" />
    <FormField fieldType="telephone" id="telephone" label="Telephone" />
    ...
    <Button type="submit" action="submit" label="Submit form" mode="primary" />
