---
path: "/atoms/inputTelephone/guide"
type: "intro"
level: "atoms"
...
According to the <a href="https://www.w3.org/WAI/standards-guidelines/wcag/" target="_self">Web Content Accessibility Guidelines (WCAG)</a>, it is highly reccomended to use a label together with the telephone input.
</div></div>
