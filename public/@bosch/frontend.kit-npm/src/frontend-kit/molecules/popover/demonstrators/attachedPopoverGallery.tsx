...
const AttachedPopoverGalleryDemonstrator: React.FunctionComponent<
  AttachedPopoverGalleryDemonstratorProps
> = ({ paragraph }) => (
  <div className="frontend-kit-example_attached-popover-gallery">
    {arrowPositions.map((arrowPosition) => {
      return (
        ...
        >
          <Button label={arrowPosition} action={arrowPosition} mode="primary" />
          <Popover
            paragraph={paragraph}
            buttonLabelPrimary="close me"
            closeButton
            detached={false}
